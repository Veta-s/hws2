...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): AffairType[] => { // need to fix any
    return affairs.filter(affair=> {
        switch (filter){
            case "high": {
                return affair.priority === 'high'
            }
            case "low": {
                return affair.priority === 'low'
            }
            case "middle": {
                return affair.priority === 'middle'
            }
            default: return affair
        }
    })
}
export const deleteAffair = (affairs: AffairType[], _id: number): AffairType[] => { // need to fix any
    let newAffair = affairs.filter(affair => affair._id !== _id)
    return newAffair
}
